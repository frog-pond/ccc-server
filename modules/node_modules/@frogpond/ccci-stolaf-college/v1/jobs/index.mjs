...
export function cleanJob(job) {
	...
	const description = cleanTextBlock(JSDOM.fragment(job.description).textContent)
	...
	const links = getLinksFromJob({description, comments, skills})
...
export function getLinksFromJob({description, comments, skills}) {
